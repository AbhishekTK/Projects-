...
<form action="Login.php" method="post" name="SignIn" onsubmit="return validate();">
<fieldset>
<p><input type="text" required value="Email ID" name="email" onBlur="if(this.value=='')this.value='Email ID'" onFocus="if(this.value=='Email ID')this.value='' "></p>
...
<p><input type="submit" value="Login" name="sub_btn" onclick="FirstL.html"></p>
</fieldset>
</form>
